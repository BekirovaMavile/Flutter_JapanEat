...
class CartScreenState extends State<CartScreen> {
  ...
  void onIncrementTap(Food food) async{
    await FoodState().onIncreaseQuantityTap(food);
    setState(() {
    });
  }

  void onDecrementTap(Food food) async{
    await FoodState().onDecreaseQuantityTap(food);
    setState(() {
    });
  }
  void onRemoveFromCart(Food food) async {
    await FoodState().onRemoveFromCartTap(food);
    setState(() {
    });
  }
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    CounterButton(
                      onIncrementTap: () => onIncrementTap(food),
                      onDecrementTap: () => onDecrementTap(food),
